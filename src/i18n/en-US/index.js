...
export default {
  ...
  mapPose: 'Waypoints',
  mapPose_title: 'Waypoint List',
  mapPose_add: 'Add Waypoint',
  mapPose_save: 'Save Waypoints',
  mapPose_load: 'Reload Waypoints',
  mapPose_remove: 'Delete Selected',
  mapPose_empty: 'No waypoints yet. Load a map, move the robot, then tap Add.',
  mapPose_local_hint: 'Stored locally (backend /pose_list not connected)',
